...
describing the world. This service watches its **propensity score** — the distribution of scores the model produces — and reports
...
numeric PSI over quantile bins of the training score distribution. Population Stability Index, read against the conventional thresholds:
